/*
  ...
  изменять её в соответствии с условиями GNU General Public License версии 3
  или любой более поздней версии, опубликованной Free Software Foundation.

  Эта программа поставляется «как есть», без каких-либо гарантий, даже без подразумеваемых
  гарантий товарной пригодности или пригодности для конкретной цели.
  Подробнее см. в лицензии GNU General Public License версии 3, доступной по адресу:
  <https://www.gnu.org/licenses/gpl-3.0.html>

  Вы должны были получить копию этой лицензии вместе с этой программой.
  Если нет, посетите: <https://www.gnu.org/licenses/>
  ...
  --- СПИСОК ИЗМЕНЕНИЙ ---
  [2025-XX-XX] UterGrooll: Основные изменения в библиотеке:
